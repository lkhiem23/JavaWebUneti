 ...
 * @author ADMIN
 */
@WebServlet(urlPatterns = {"/XLXoaSP_LeHoaiKhiem"})
public class XLXoaSP_LeHoaiKhiem extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        request.getRequestDispatcher("XoaSP_LeHoaiKhiem.jsp").forward(request, response);
    }
